...
import { ConnectionQualityIndicator, TrackMutedIndicator, FocusToggle, VideoTrack, AudioTrack, useIsEncrypted } from '@livekit/components-react';
import { ParticipantName, ParticipantPlaceholder, useParticipantTile } from '@livekit/components-react';
import {
  ParticipantContext,
  TrackRefContext,
  useEnsureTrackRef,
              ...
              <>
                ...
                <div className="lk-participant-metadata">
                  <div className="lk-participant-metadata-item">
                    {trackReference.source === Track.Source.Camera ? (
                      <>
                        {isEncrypted && <IconLockLocked style={{ marginRight: '0.25rem' }} />}
                        <TrackMutedIndicator
                          trackRef={{
