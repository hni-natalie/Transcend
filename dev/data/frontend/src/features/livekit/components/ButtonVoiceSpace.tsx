...
export function ButtonVoiceSpace( { joinText='Join Room', leaveText='Leave Room', roomName='myroom', allowLeave=true, mode="call", className='', showMute=true, joinTo, leaveTo } : ButtonVoiceSpaceProps) {
