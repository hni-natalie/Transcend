          ...
          <div className="space-y-4">
            ...
            <div className="space-y-5">
              ...
              {upcomingMeetings.length === 0 && (
                <div className="text-left text-foreground-3 px-6 py-1">No upcoming meetings</div>
              )} */}
            </div>
          </div>
...
// // const getSpaceName = (departmentName: string) => {
// //   const spaceMap: Record<string, string> = {
// //     'Human Resources': 'People Ops Hub',
// //     'Accounts': 'Audit Vault',
// //     'Marketing': 'Growth Lab',
// //     'Operations': 'Logistics Ops Hub',
// //     'Engineering': 'Dev Lab',
// //     'Design': 'Creative Lab'
// //   };
// //   return spaceMap[departmentName] ?? departmentName;
// // };
