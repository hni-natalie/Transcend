...
export function UploadPhoto ({
	...
	return (
		...
		<div className='flex'>
			...
			{/* <label */}
			{/* for="photoUpload"  */}
			<div onClick={handleClick} className="flex flex-col items-center justify-center w-24 h-24 rounded-full bg-background-2 cursor-pointer overflow-hidden">
			...
			<div id='cameraIcon' className='text-accent-lime hover:text-white hover:scale-110 transition-transform duration-300'>
